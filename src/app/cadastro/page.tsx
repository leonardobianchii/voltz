...
const Cadastro = () => {
    ...
    return (
        <div>
            ...
            >
                <div className="mb-4">
                    <label htmlFor="nome" className="block mb-1 text-gray-700">Nome:</label>
                    <input
                        name="nome"
                        id="nome"
                ...
                <div className="mb-4">
                    <label htmlFor="telefone" className="block mb-1 text-gray-700">Telefone:</label>
                    <input
                        name="telefone"
                        id="telefone"
                ...
                <div className="mb-4">
                    <label htmlFor="login" className="block mb-1 text-gray-700">Login:</label>
                    <input
                        name="login"
                        id="login"
                ...
                <div className="mb-4">
                    <label htmlFor="senha" className="block mb-1 text-gray-700">Senha:</label>
                    <input
                        type="password"
                        name="senha"
                        id="senha"
